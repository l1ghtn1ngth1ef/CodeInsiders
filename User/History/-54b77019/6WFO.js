...
export default function HotBuild() {
    ...
    const hmrBuild = async () => {
        bundling = true
        await build({'build': { ssr: '--ssr ./SSRServer/SSRServer.jsx --outDir ./BasePlatForm/SSRServer', outDir: './BasePlatForm/CSRServer'}}) // <--- you can give a custom config here or remove it to use default options
